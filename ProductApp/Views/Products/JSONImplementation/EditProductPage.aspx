<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditProductPage.aspx.cs" Inherits="ProductApp.Views.Products.JSONImplementation.EditProductPage" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:HiddenField runat="server" ID="ProductIdField" />
            ...
            <asp:RequiredFieldValidator ID="ProductNameValidator" runat="server" ErrorMessage="Name cannot be blank" ControlToValidate="ProductNameTextBox" ForeColor="Red"></asp:RequiredFieldValidator>  <br />
             ...
             <asp:Button ID="EditProductButton" runat="server" Text="Submit" OnClick="EditProductButtonClick" />
        </div>
    </form>
</body>
</html>
